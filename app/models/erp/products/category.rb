module Erp::Products
  class Category < ApplicationRecord
    ...
    has_and_belongs_to_many :property_groups, -> { order 'erp_products_property_groups.created_at' }, class_name: "Erp::Products::PropertyGroup", :join_table => 'erp_products_categories_pgroups'
